    <!-- Footer -->
    <footer class="footer">
        © 2021 E-Presensi <span class="d-none d-sm-inline-block"> - built with <i class="mdi mdi-heart text-danger"></i> PKKMB FMIPA 2021</span>.
    ...
    <!--Morris Chart-->
    <script src="<?= base_url('assets/app-assets/template/presensi-abdul/horizontal/'); ?>../plugins/morris/morris.min.js"></script>
    <script src="<?= base_url('assets/app-assets/template/presensi-abdul/horizontal/'); ?>../plugins/raphael/raphael.min.js"></script>
    ...
    <?php $this->load->view('engine/core'); ?>
