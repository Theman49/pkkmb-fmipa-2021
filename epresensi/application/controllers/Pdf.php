...
class Pdf extends CI_Controller
{
    ...
    public function absensi($data)
    {
        ...
        // <img src="https://pkkmbfmipaunnes.web.id/epresensi/assets/img/logo.png" width="120px" style="margin-top: 20px;" alt="">
        // </div>', 'O');
        // $mpdf->SetHTMLHeader('<div style="text-align: left; margin-left: 20px; font-weight: bold;">
        // <img src="https://pkkmbfmipaunnes.web.id/epresensi/assets/img/logo.png" width="120px" style="margin-top: 20px;" alt="">
        // </div>', 'E');
        ...
        <table border="0" width="100%" style="vertical-align: bottom; font-family: serif; 
            ...
            <tr border="0">
                ...
                <td width="33%" style="text-align: right; border: none;">E-Presensi by PKKMB FMIPA 2021</td>
            </tr>
        ...
        <table border="0" width="100%" style="vertical-align: bottom; font-family: serif; 
            ...
            <tr border="0">
                <td width="33%"><span style="font-weight: bold; font-style: italic;">E-Presensi By PKKMB FMIPA 2021/span></td>
        ...
        $html = '
            ...
            <body>
            <h2 style="text-align: center;">E-PRESENSI BY PKKMB FMIPA 2021<br><small>Built With Codeigniter 3 & PHP 7</small></h2>
                <p style="text-align: center;">Edited by Panitia PKKMB FMIPA 2021</p>
                <hr>
                <center>
                    <table width="100%" align="center" style="border: none;">
                        <tr>
                            <th style="border: none;">Nomor Acara</th>
                            <th style="border: none;">Nama Acara</th>
    ...
    public function exportqr($data)
    {
        ...
        $html = '
            ...
            <body>
                <h2 style="text-align: center;">E-PRESENSI BY PKKMB FMIPA 2021<br><small>Built With Codeigniter 3 & PHP 7</small></h2>
                <p style="text-align: center;">Edited by PKKMB FMIPA 2021</p>
                <hr>
                <p style="text-align: center; font-weight: bold;">QR Code Presensi ' . $event->nama_event . '</p>
                <div style="margin-left: 150px;">
                    <img src="' . 'https://pkkmbfmipaunnes.web.id/epresensi/assets/app-assets/qr/img/' . $event->qr_event . '" alt="Gambar Qr">
                </div>
            </body>
            </html>';
