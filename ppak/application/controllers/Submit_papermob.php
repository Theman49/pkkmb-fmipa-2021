...
class Submit_papermob extends CI_Controller {
	...
	private function getClient()
		{
		    ...
		    $credentialsPath = $_SERVER['DOCUMENT_ROOT']. "/application/libraries/credentials-drive.json";
		    ...
		    // time.
		    $tokenPath = $_SERVER['DOCUMENT_ROOT']. "/application/libraries/token.json";
	...
	public function index(){
		...
		if( isset( $_POST['submit'] ) ){
		    ...
		    $fileName  = $kodeWarna."_".$_POST['namaFile']."_".$noKelompok.".".$file_type;
			...
			if ($_FILES['file']['size'] > 5 * 1024 * 1024 ){
			 //   echo "<script>alert('tak tau:)');document.location.href = '".site_url('penugasan')."'</script>";
		  ...
		  //  echo $success;
		    if( $success ){
				// redirect('penugasan');
				// header('Location : https://pkkmbfmipaunnes.web.id/penugasan');
				
		  //  	echo "<script>alert('File Berhasil Diupload :)');document.location.href = '".site_url('penugasan')."'</script>";
                ...
                echo "<script>document.location.href = '".site_url('penugasan/deskripsi_penugasan')."'</script>";
		    }
		}
